 ...
 *
 * Disassembly of DSDT.aml, Thu Jul 23 16:20:26 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00012BF2 (76786)
 *     Revision         0x02
 *     Checksum         0x92
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I"
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I", 0x00000023)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xCE7DFC18, 0x0362)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xCE29AE98, 0x10)
    ...
    OperationRegion (ABNV, SystemMemory, 0xCE7DA000, 0x000D)
    ...
    Scope (_SB)
    {
        Device (PTMD)
        {
            ...
            {
                OperationRegion (GCAD, SystemMemory, 0xCE7C9018, 0x04EC)
            ...
            Method (GXDV, 1, NotSerialized)
            {
                ...
                OperationRegion (PRFA, SystemMemory, 0xCE7C7018, 0x00F0)
